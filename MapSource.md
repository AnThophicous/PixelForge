...
- [x] Compilar APK Android debug no GitHub Actions e publicar artefato `PixelForge-debug-apk`.
- [ ] Instalar APK Android em dispositivo real.
...
- `medium` — `android/`: o APK debug foi compilado no GitHub Actions, mas a instalação e o upscale real ainda não foram observados no Hot 50 Pro; o host local continua sem Java, Android SDK, Gradle ou adb.
